...
# for thermal-engine access
chown -h root.root /sys/class/power_supply/battery/thermal_charge_current_max
chown -h root.root /sys/class/power_supply/usb/thermal_state
